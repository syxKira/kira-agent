# chat-event-aggregation Specification

## Purpose

Define Kira's frontend chat event aggregation contract: the default web timeline
renders conversation turn view models built from transcript messages, the active
prompt, and live Kira events instead of rendering raw stream events as primary
message cards.
## Requirements
