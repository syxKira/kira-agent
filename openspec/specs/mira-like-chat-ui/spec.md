# mira-like-chat-ui Specification

## Purpose

Define Kira's default Mira-like chat surface: a light conversation-first web UI
that keeps Stage 13 turn aggregation, hidden-thinking separation, inline tool
activity, and composer/HITL behavior while removing dashboard/debug content from
